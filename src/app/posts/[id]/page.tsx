        ...
        <div className="px-4 py-6 sm:px-0">
          {isLoading ? (
            ...
            <div className="bg-red-50 text-red-600 p-4 rounded-md">
              <p>Post not found. <Link href="/posts" className="underline">Return to posts list</Link></p>
            </div>
          ) : (
            <>
              <div className="flex items-center mb-6">
                <Link href="/posts" className="text-blue-600 hover:text-blue-800 mr-2">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M9.707 16.707a1 1 0 01-1.414 0l-6-6a1 1 0 010-1.414l6-6a1 1 0 011.414 1.414L5.414 9H17a1 1 0 110 2H5.414l4.293 4.293a1 1 0 010 1.414z" clipRule="evenodd" />
                  </svg>
                </Link>
                <h1 className="text-2xl font-semibold text-gray-900">Post Details</h1>
              </div>
                  ...
                  {author && (
                    <div className="flex items-center mb-6">
                      ...
                      <div>
                        ...
                        <Link href={`/users/${author.id}`} className="font-medium text-blue-600 hover:underline">
                          {author.name}
                        </Link>
                      </div>
                    </div>
